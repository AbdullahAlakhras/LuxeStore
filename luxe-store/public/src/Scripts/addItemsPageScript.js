...
async function addItemInServer(link ,description ,quantity, nameProduct,price,type,sellerName,companyName){
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    // await addItemInServer("dsdsd","dsds",2,"wqreds",232,"dsds","user2","sdasd");
    ...
    async function addItemAction(){
        ...
        await addItemInServer(link,description,quantity,productName,price,typeOfProduct,activeUser,company);
        alert("Item Added");
        // const seller={
        //     companyName: company ,
